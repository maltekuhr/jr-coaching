      ...
      <div className="relative">
        ...
        <div className="max-w-3xl mx-auto relative h-full">
          <div className="relative z-10 h-full">
            {/* Logo Section */}
            <header className="flex items-center justify-center p-4 pt-10 bg-gradient-to-b from-background to-transparent">
              <div className="flex items-center gap-2">
                <img src="/logo.svg" alt="logo" className="size-16 fill-background" />
              </div>
            </header>
            ...
            {/* Main Content */}
            <main className="pb-44 md:pb-20 pt-10 px-8 text-foreground">
              <div className="max-w-xl space-y-4">
                ...
                <div className="space-y-4 pt-4 grid">
                  <Button className="w-full bg-primary border-2 border-foreground text-primary-foreground rounded-xl text-lg py-5 font-bold hover:bg-primary/90  uppercase">
                    Jetzt anfragen
                  </Button>
                  <Button className="text-lg py-5 text-foreground font-bold bg-transparent rounded-xl border-foreground border-2  uppercase hover:bg-foreground/10 focus-visible:text-background">
                    Mehr erfahren
                  </Button>
                </div>
              </div>
